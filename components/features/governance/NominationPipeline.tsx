          ...
          return (
            <div key={stage} className="w-44 shrink-0">
              ...
              <div className="space-y-2">
                {col.map((r) => (
                  <div key={r.id} className="rounded-lg border border-canopy/10 bg-white p-3 shadow-sm">
                    <p className="text-xs font-semibold text-ink/75">{r.fullName}</p>
                    <p className="text-[11px] text-ink/40">{r.communityName}</p>
